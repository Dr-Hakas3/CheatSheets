...
## [Winpeas](../97_tools/windows_privilege/winpeas.md)
...
[PowerView](../97_tools/active_directory/Powerview.ps1.md)
*調査を進めやすくするため最初にインポートしておく*

## Domain Userの列挙
[kerbrute](../03_services/88_kerberos.md)
...
👉If:
- SPN detected? → [Kerberoast](Attacks_on_AD_authentication/Kerberoasting.md) candidate
...
[PsLoggedOn.exe](../97_tools/PsLoggedOn.exe.md)
...
[DC Sync](Attacks_on_AD_authentication/DC_Synchronization.md)

[Golden Ticket](Attacks_on_AD_authentication/Golden_Ticket.md)
