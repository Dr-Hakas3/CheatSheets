...
C:\Windows\system32>cd c:\users\adminsitrator\desktop
cd c:\users\adminsitrator\desktop
The system cannot find the path specified.

C:\Windows\system32>cd c:\users\adminisitrator\desktop
cd c:\users\adminisitrator\desktop
The system cannot find the path specified.
...
type proof.txt
08048cc97f87d1a9936311b141f0b73f
```
